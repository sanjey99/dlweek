...
import {
  Users, Bot, TrendingUp, Ban, AlertTriangle, ChevronDown, ChevronUp,
...
/* ═══ MAIN COMPONENT ═══════════════════════════════ */
export function OrganisationPage({ theme, isDark, isMobile }: OrganisationPageProps) {
        ...
        {filteredTeams.map((team) => {
          ...
          return (
            <div key={team.id}>
              ...
              {isExpanded && <ExpandedTeamDetails team={team} theme={theme} isMobile={isMobile} />}
            </div>
          );
        })}
      </div>
